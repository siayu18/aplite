...
<body>
    ...
    <div class=" col-12 col-s-12 content-mid fade-in">
        <div class="main-container">
            ...
            <form method="POST" action="create_announcement.php" class="inner-container">
                <div class="medium-green-title">Create Announcement</div>
    ...
    <div class="modal">
        ...
        <div class="text-group">
            ...
            <span class="green-description">You have successfully created the announcement</span>
        </div>
